...
### 2.3 Hard roles are event roles, not propagated packets
Hard Fourier projectors are used when an actual physical event is read.
Smooth scalar PDE envelopes are propagated between events.
