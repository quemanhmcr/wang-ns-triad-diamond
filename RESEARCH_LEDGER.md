...
Thus **temporal coefficient survival-or-first-stop is no longer the high-strain seam**.  The remaining high-strain seam is material/efficiency attachment: couple the surviving critical smooth coefficient to the retained NN witness strongly enough to start the canonical material-service epoch, or route failure to an already named physical cause.  Universal source/relink re-entry remains open.
