...
def theorem_certificate() -> dict[str, object]:
    return {
        ...
        "continuum_status": "this closes the algebraic currency identity of the nonaffine Heisenberg interface; quantitative eventwise stopping still uses the existing coherent K_coh/strain/D_V and material-relink thresholds on the selected physical transfer measure",
    }
