...
def theorem_certificate() -> dict[str, object]:
    return {
        ...
        "continuum_status": "frequency-role/transfer-cell registration is exact at the event and coefficient levels; remaining quantitative closure is the already isolated nonaffine envelope-interface first-stop, to be consumed by coherent K_coh/strain/D_V or physical relink/transfer loss",
    }
