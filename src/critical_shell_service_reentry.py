...
def theorem_certificate(scaled_lifetime: float = 1.0, viscosity: float = 1.0) -> dict[str, object]:
    ...
    return {
        ...
        "service_depth": "Moyal/material rereading of that full-survivor service adds zero physical-time drop and zero recursion depth; a downstream theorem must supply any genuinely new state/time it creates",
