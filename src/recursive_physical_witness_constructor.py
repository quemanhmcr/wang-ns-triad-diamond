...
def theorem_certificate() -> dict[str, object]:
    return {
        ...
        "continuum_status": "local first-hit extraction and generated-survivor smooth-carrier/parent-cutoff relay are supplied; remaining PDE bridge is universal physical slab renewal/exhaustion for every recursive source/dissipation/relink route",
    }
