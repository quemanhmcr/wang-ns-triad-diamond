...
def theorem_certificate() -> dict[str, object]:
    ...
    return {
        ...
        "weights": "this registration theorem does not replace physical energy weights; no coefficient impulse magnitude is work, and actual Q^2 carrier energy/work supplies later causality",
        "continuum_status": "the moving-role equation and Q^2 energy handoff now exist; coefficient registration failure is a locator for physical-energy reentry, while global recursive owner termination remains open",
    }
