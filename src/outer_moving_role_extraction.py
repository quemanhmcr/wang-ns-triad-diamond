...
def theorem_certificate() -> dict[str, object]:
    ...
    return {
        ...
        "continuum_status": "the outer moving-role PDE and persistent low-low exclusion are exact; the smooth quadratic-carrier theorem recombines commutator and diagonal role work at Q^2, then quotients the certified common affine/Kelvin gauge before any residual skew work is called physical relink; the hard-projector theorem remains the event specialization",
    }
