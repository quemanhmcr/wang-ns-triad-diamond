...
def theorem_certificate() -> dict[str, object]:
    return {
        ...
        "maxwell_metric_alignment_gap": "T^2=(|T|^2/4)I4 forces Maxwell spectrum (+sigma,+sigma,-sigma,-sigma); against material metric spectrum (s1,s2,s3,0), sum si=0, one has sharply |T:dot G|<=sqrt(2/3)|T||dot G|, with equality exactly at the same Weyl-wall ratio (2,-1,-1) that saturates |det K|<=|K|^3/(3sqrt6)",
