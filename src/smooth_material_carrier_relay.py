...
def theorem_certificate() -> dict[str, object]:
    return {
        ...
        "previous_slab": "the existing outer moving-role equation and physical energy gate apply to the same smooth Q carrier; its native energy effect is Q^2 and its commutator work must be recombined with diagonal L_V role work before residual ownership",
