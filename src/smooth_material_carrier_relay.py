...
def theorem_certificate() -> dict[str, object]:
    return {
        ...
        "previous_slab": "the existing outer moving-role equation and physical energy gate apply to the same smooth Q carrier; its native energy effect is Q^2; commutator work is recombined with diagonal L_V role work, and common transported gauge motion is quotiented before residual ownership",
