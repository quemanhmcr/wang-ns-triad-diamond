...
def theorem_certificate() -> dict[str, object]:
    return {
        ...
        "primitive_turning_frontier": "the previous persistent critical near-kernel frontier is now lowered to the exact two-particle roads: blocking infinite productive regeneration is an unproved quantitative stability/history problem coupling inward separation flux to center-label/material Hodge turnover, with Gc/Gamma_u retained as exact readings rather than a static coercive closure",
