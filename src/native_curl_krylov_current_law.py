...
def theorem_certificate() -> dict[str, object]:
    return {
        ...
        "primitive_two_road_frontier": "the exact pair law has only common/center relay and relative/separation transport: infinite inward r-flux on finite viscous history must be coupled to center-label turnover, whose non-free cost is already encoded by material Hodge/deformation current; this historical coupling is unproved",
        ...
        "primitive_turning_frontier": "the previous persistent critical near-kernel frontier is now lowered to exact pair geometry: blocking infinite productive regeneration requires promoting K_parallel:K_perp=1:3 and div_r delta u=0 from compulsory transverse stock to transverse time-action, then identifying that history with center-label/material Hodge turnover; this quantitative stability/history bridge is unproved",
