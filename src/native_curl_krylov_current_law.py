...
def theorem_certificate() -> dict[str, object]:
    return {
        ...
        "primitive_two_road_frontier": "the exact common-relative pair law leaves one escape: a shrinking affine-like relative-energy front at r=0; excluding it requires a historical anti-concentration theorem coupling inward pair transport to the homogeneous affine defect C whose exact critical norm is M3; this no-shrinking-affine-front theorem is unproved",
        ...
        "primitive_turning_frontier": "the previous persistent critical near-kernel frontier is lowered to the common-relative pair field W and affine defect C: K is ||W||^2, M3 is ||grad_c W||^2, fixed-r energy forces escape to r=0, and blocking infinite productive regeneration is now the unproved quantitative stability/history problem of excluding a shrinking affine front at finite energy",
