...
def theorem_certificate() -> dict[str, object]:
    return {
        ...
        "primitive_regeneration_persistence": "the historical nu_E=kappa/M3 reading remains exact, and the old necessity int kappa^2/[N^2(EZ-K^2)] dt=infinity is exactly int a^2/N^2 dt=infinity and the Poisson-boundary action Escript|R'_E|^2/[Escript_yy(Escript Escript_yy-Escript_y^2)]; the remaining theorem is the heat-paid orientation/Lax-Krein return law exposed by the covariant w equation, without losing the extra |C| weight",
        ...
        "primitive_two_road_frontier": "the historical successfully regenerated/accumulated infinitely often language now bottoms out at the normalized projector/Lax law P_t=[A_e,P]-nu[P,[P,Lambda^2]]: Euler is a self-generated reversible commutator, heat is one-way double-bracket sorting, and the unresolved nonradial data is the exact covariant w/Lax-Krein orientation equation; the unproved theorem is a historical return/transgression law making int a^2/N^2 dt finite",
        ...
        "primitive_turning_frontier": "the historical persistent critical near-kernel, infinite productive regeneration and quantitative stability/history readings now reduce to self-generated orientation: radial generators V_r and V_(r^2) commute, while the exact covariant w equation and the G-symmetric helicity-odd Lax/Krein boost carry the noncommutativity; the missing theorem is an exact heat-paid historical return law for this orientation, not a norm-only closure",
