...
Status: **EXACT_SMOOTH_PHYSICAL_RELINK_DONOR_QUOTIENT__GAUGE_QUOTIENTED_KPHYS_PAIR_FLUX__FINITE_SAME_EVENT_NEGATIVE_DONOR_CLOSURE__SMOOTH_RELINK_ZERO_RECURSION_DEPTH**.
...
Stress: `200000` bound smooth relink laws
- sampled native pair-work scale range: `[1.176e-141,1.577e+141]`
- worst native-relative pair antisymmetry residual: `0.000e+00`
- worst native-relative row-binding residual: `0.000e+00`
- worst native-relative total relink residual: `1.593e-15`
- minimum native-relative incoming-minus-recipient-gain margin: `0.000e+00`
- donor-existence failures: `0`
- maximum shortest donor path: `3`
