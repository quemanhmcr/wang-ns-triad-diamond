...
Stress:
- arbitrary continuum fibers: `3000`
- near-extremal physical core blocks: `100`
- worst helical reconstruction residual: `1.839e-15`
- worst ordered/unordered quotient residual: `0.000e+00`
- worst parent-swap residual: `0.000e+00`
- worst direct/modal work relative residual: `4.873e-13`
- worst direct/modal progress relative residual: `6.974e-13`
- minimum Hahn margin over aggregate positive work: `1.462e-01`
- minimum Hahn margin over fiber-positive work: `3.865e-02`
- worst polarization residual: `4.441e-16`
- signed flux ratio range: `[-0.298859787,0.315752808]`
- random blocks carrying positive nonforward edge work: `515`
- minimum good-core capacity Markov margin: `2.825e-03`
