...
Stress: `50000` exact coefficient/service/switch states
- minimum transparent quarter-coefficient margin: `8.096e-04`
- worst same-role Duhamel residual: `8.564e-14`
- worst service-total/reclassification residual: `1.137e-13`
- minimum selected-family switch-jump margin: `-1.421e-14`
- label-transparency failures: `0`
- switch-charge losses: `0`
- role-delegate failures: `0`
- maximum carrier-stop count: `2`
- maximum simultaneous first-stop event count including sidecars: `4`
- outcomes: `{'carrier_continues': 2595, 'carrier_first_stop': 7571, 'carrier_first_stop_with_material_sidecars': 22406, 'carrier_continues_with_material_sidecars': 7595, 'delegate_role_or_probe_change': 9833}`
