# High strain -> critical dissipation law -> own-scale service re-entry
...
Stress: `50000` critical-dissipation-law/first-stop/service states
- minimum renewed seed critical-mass margin: `5.808e-05`
- minimum sampled normalized dissipation weight: `4.413e-06`
- minimum full-survivor critical-mass margin: `2.909e-01`
- minimum sampled own-scale service threshold: `2.700e-13`
- worst exact Duhamel residual: `4.974e-14`
- monitor-order failures: `0`
- monitor-unit failures: `0`
- maximum sampled exact joint first-stop count: `1`
- outcomes: `{'named_first_stop': 30183, 'full_natural_own_scale_service': 9855, 'initial_boundary_root': 9962}`
