...
- physical mode sets checked: `200000`
- proper boundary-flow cases: `100000`
- full closed-triad sets: `100000`
- worst recipient decomposition native residual: `0.000e+00`
- worst donor decomposition native residual: `0.000e+00`
- worst boundary-divergence native residual: `2.141e-16`
- maximum sampled internal/boundary flow ratio when boundary was nonzero: `23223.7143117`
