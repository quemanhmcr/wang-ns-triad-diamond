...
Status: **ORTHOGONAL_FOURIER_GALERKIN_NS_PURE_UV_TRUE_UPWARD_FIRST_SHELL__ACTUAL_CANONICAL_RECIPIENT_CAUSE__M_EQUALS_2N__H_EQUALS_U_BY_STRICT_SUPPORT__NO_OUTPUT_SCALE_SELECTION**.
...
- pure common-work cross-FFT relative spread: `2.087e-16`
- minimum physical parent margin above M/4: `2.40312423743`
- maximum p_scale residual: `0.000e+00`
- pure/contact coexistence observed: `True`
- minimum initial deep-contact / coexisting pure-UV work: `0.0748690219794` / `0.039721764731`
- upstream pure-support representation residual: `2.087e-16`

## resolution 24
- pure physical/common work: `8.51111181869` / `68.0888945495`
- recipient charges / donor sidecars: `1` / `1`
- shell index/scale: `1` / `16`
- parent upper ratio: `0.40019526484`
