...
- maximum total-work representation native residual: `1.045e-16`
- maximum good-recipient representation native residual: `8.712e-17`
- maximum bad-recipient representation native residual: `2.178e-17`

## resolution 24
- steps/snapshots: `48` / `6`
- worst row/column native residuals: `5.242e-17` / `3.480e-17`
- worst fate-partition native residual: `0.000e+00`
- worst restricted-donor pushforward native residual: `5.242e-17`
- worst fine/coarse total/fate native residuals: `0.000e+00` / `0.000e+00`
- NS energy-balance residual: `1.758e-12`
- initial donor/recipient counts: `1` / `2`
- initial good/bad recipient masses: `18.6989126657` / `5.96461874029`
