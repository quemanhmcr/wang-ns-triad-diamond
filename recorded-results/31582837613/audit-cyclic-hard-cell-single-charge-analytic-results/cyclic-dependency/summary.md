...
Status: **EXACT_CYCLIC_HELICAL_TRIAD_DONOR_KERNEL__FULL_S3_CLOSED_TRIAD_QUOTIENT__THREE_ROOT_SIGNED_NS_ENERGY_CONSERVATION__CANONICAL_DW_MINUS_TO_DW_PLUS_MARGINALS__SIGNED_GOOD_UNIQUE_DONOR_AND_NONFORWARD_SIDE_RECIPIENT**.
...
Stress: `100000` generic physical closed triads
- one-donor cases: `50187`
- two-donor cases: `49813`
- exact zero-native-work cases: `0`
- numerically unresolved near-zero work cases: `0`
- worst cyclic energy-conservation native residual: `1.844e-16`
- worst cyclic-coupling native residual: `3.377e-16`
- worst density donor/recipient native residuals: `9.167e-17` / `9.065e-17`
- worst measure donor/recipient native residuals: `9.592e-17` / `9.760e-17`
- worst restricted dW- to canonical dW+ submeasure native mass residual: `1.248e-16`
- worst permutation / translation work native residuals: `0.000e+00` / `2.098e-16`
- worst wavevector / amplitude scaling native residuals: `2.333e-16` / `2.700e-16`
- worst global-reality work-multiset native residual: `1.291e-16`
