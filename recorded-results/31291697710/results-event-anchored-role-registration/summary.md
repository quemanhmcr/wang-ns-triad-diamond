# Event-anchored hard roles inside a smooth moving PDE envelope
...
Stress: `50000` exact hard-role/envelope/source states
- worst hard partition residual: `7.573e-16`
- worst hard-to-envelope coefficient residual: `1.472e-16`
- minimum L3 contraction margin: `9.593e-02`
- minimum L2 contraction margin: `1.548e-01`
- worst full HH bilinear partition residual: `1.014e-16`
- minimum sampled envelope/low-low support gap: `3.198655e-02`

This closes the frequency-role/transfer-cell alignment seam without identifying a smooth envelope with a physical packet.  The only quantitative outer-role continuation issue left is the nonaffine envelope-interface first stop already isolated by the companion theorem; on a near-Gaussian event its small branch is the existing coherent `K_coh` connection bound, and its large branches are strain/critical `D_V` or actual material/role relink.  No global-regularity claim is made.
