...
Status: **EXACT_PURE_UV_TRUE_UPWARD_FIRST_SHELL_NATURAL_WINDOW__CANONICAL_RECIPIENT_SUBMEASURE_SINGLE_CHARGED__H_EQUALS_U_ON_BOTH_PARENTS__P_SCALE_ONE__EDGE_TOTAL_VARIATION_BEFORE_YOUNG__COMMON_N_DW_UNIT**.
...
Stress: `100000` random physical closed-triad draws
- resolved triads: `100000`
- pure-UV donor atoms / coalesced recipient causes: `123099` / `123099`
- maximum parent/shell ratio: `1.43955108032`
- donor/shell range: `0.250000116655` / `0.499999635558`
- interior donor-ratio atoms (`|k_d|/M<0.49`): `111688`
- maximum coalescing residual: `0.000e+00`
- minimum natural-window margin: `1.042e-10`
- p_scale residual: `0.000e+00`
- edge-total-variation / clean-Young ratio: `0.0897935610626`
