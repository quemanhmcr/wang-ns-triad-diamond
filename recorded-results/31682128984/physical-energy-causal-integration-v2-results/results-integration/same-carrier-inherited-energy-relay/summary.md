...
Status: **EXACT_SAME_CARRIER_INHERITED_ENERGY_RELAY__PHYSICAL_STOCK_CONTINUATION_NOT_GENERATION__NO_EVENT_CHECKPOINT__MATERIAL_SIDECARS_PRESERVED_SEPARATELY__ROLE_OR_PROBE_CHANGE_FAILS_CLOSED__NO_TEMPORAL_DEPOSIT_MATCHING**.
...
Stress: `50000` exact same-carrier paths
- relays checked: `50000`
- stock relays carrying material sidecars preserved for separate routing: `25000`
- maximum inserted checkpoints: `3`
- minimum inheritance-gate margin: `6.973e-07`
- maximum physical elapsed-time residual: `1.388e-17`
- recursive events created by the stock component: `0`
