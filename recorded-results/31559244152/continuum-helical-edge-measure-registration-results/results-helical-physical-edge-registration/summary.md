...
Stress: `10000` random physical helical triads/amplitudes
- worst direct-Leray / Waleffe coefficient relative residual: `5.018e-16`
- worst Leray-free child pairing residual: `1.905e-16`
- worst `T log = A J c` relative residual: `1.936e-13`
- worst unordered-parent swap residual: `3.878e-11`
- worst helical phase-gauge alignment residual: `1.110e-15`
- worst uniform-wavevector scale invariance residual: `3.931e-12`
- maximum sampled `J/J_*`: `0.997347374247`
- minimum phase alignment on sampled positive forward-work edges: `5.732e-04`
- positive forward-work samples: `3329`
- nonforward samples (zero upper-progress multiplier, retained rather than mislabeled signed-good): `3408`
