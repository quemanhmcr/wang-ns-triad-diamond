# Bargmann root-cell registration: a large Gaussian coefficient forces actual Moyal cell energy
...
`9/(2e^3) = 0.224041807655`.

The radius-`sqrt3` ball intersects at most `15625` unit cells of the fixed six-dimensional intrinsic grid.  Therefore one actual canonical coherent cell has

`N E_C >= 2.96859945386e-06`
...
The global root budget is also depth independent.  Inside one exact outer frequency/helicity subrole and one covariance representative, Moyal cell energies sum with `P=1`.  The selected relative frequency roles within a scale bin are disjoint; same-color logarithmic scale bins are orthogonal; only four scale colors and the finite covariance representatives multiply the energy budget.  Thus the effective cell budget is `199504449760397376` with no packet-count or causal-depth factor.

Stress: `50000` radius/pushforward/anchor states
- minimum optimal-radius margin: `3.503e-10`
- canonical root-cell critical mass: `2.96859945386e-06`
- worst positive pushforward mass residual: `7.105e-15`
