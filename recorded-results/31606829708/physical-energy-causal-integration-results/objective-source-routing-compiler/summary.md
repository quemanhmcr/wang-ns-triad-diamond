...
Status: **EXACT_COHERENT_OBJECTIVE_SOURCE_OWNER_COMPILER__LOCAL_DV_AND_VISCOSITY_TO_CRITICAL_SHELL__SGS_FRESH_SERVICE_TO_REFINEMENT_INVARIANT_SCALE_SHELL__PRESSURE_TO_SGS_OR_ENTROPY_WEIGHTED_CRITICAL_SHELL__CELL_DOMINANCE_AND_AGGREGATE_MUV_DIAGNOSTIC_ONLY__NO_PACKET_SYNCHRONIZATION**.
...
- worst SGS closed-form relative residual: `1.258e-15`
- minimum owner-pigeonhole margin: `1.796e-03`
- minimum pressure diagnostic split margin: `-2.220e-16`
- minimum pressure entropy-shell margin: `-4.547e-13`
- minimum pressure full-survivor service registration margin: `-4.441e-16`
- minimum fresh-scale shell margin: `2.403e-05`
- minimum fresh-scale full-survivor service-conjugacy margin: `1.966e-18`
- minimum local-DV identity margin: `-2.220e-16`
...
- fresh coherent-cell argmax regressions: `0`
