# Smooth-SGS first-hit extraction from physical observables
...
Stress: `50000` physical-path/Moyal/phase/registration regressions
- monitor-order failures: `0`
- independent-unit-rescaling failures: `0`
- largest exact joint first-stop set sampled: `2`
- minimum Moyal rate inequality margin: `4.039e-09`
- worst phase branch-cut gap: `0.000e+00`
- minimum registered quarter-factor margin: `0.000e+00`
