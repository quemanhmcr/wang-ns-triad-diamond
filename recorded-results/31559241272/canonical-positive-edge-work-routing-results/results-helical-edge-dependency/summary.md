...
Stress: `20000` random physical helical triads/amplitudes
- worst direct-Leray / Waleffe coefficient relative residual: `5.018e-16`
- worst Leray-free child pairing residual: `2.174e-16`
- worst `T log = A J c` relative residual: `1.300e-11`
- worst unordered-parent swap residual: `3.878e-11`
- worst helical phase-gauge alignment residual: `1.221e-15`
- worst uniform-wavevector scale invariance residual: `1.788e-11`
- maximum sampled `J/J_*`: `0.997347374247`
- minimum phase alignment on sampled positive forward-work edges: `2.135e-06`
- positive forward-work samples: `6594`
- nonforward samples (zero upper-progress multiplier, retained rather than mislabeled signed-good): `6817`
