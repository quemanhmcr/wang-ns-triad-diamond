# Generic critical shell -> own-scale coherent-service re-entry
...
the generic terminal mass is `8pi^2/(25c^2)`, the quarter-survivor mass is `pi^2/(50c^2)`, and the carrier/service constants coincide with the already certified high-strain annular-service theorem.  At the requested `(c,nu)=(1,1)`, the specialized bounded-service threshold is `0.000233125086914`.

Stress: `50000` generic shell/supplier/corridor/service states
- minimum high-strain specialization signed margin: `0.000e+00`
- minimum generic D0 retained fraction: `0.500135189`
- minimum fresh-cluster whole-shell identity margin: `0.000e+00`
- minimum full-survivor coefficient-mass margin: `1.795e-05`
- minimum sampled own-scale service threshold: `1.041e-16`
- worst exact survivor Duhamel residual: `4.885e-15`
- monitor-order failures: `0`
- monitor-unit failures: `0`
- incomplete-horizon certification failures: `0`
- maximum sampled exact joint first-stop count: `2`
- outcomes: `{'named_first_stop': 33444, 'initial_boundary_root': 8148, 'full_natural_own_scale_service': 8408}`
