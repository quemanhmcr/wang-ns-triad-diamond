...
Stress: `75000` generic physical closed triads
- one-donor cases: `37299`
- two-donor cases: `37701`
- exact zero-native-work cases: `0`
- numerically unresolved near-zero work cases: `0`
- worst cyclic energy-conservation native residual: `1.544e-16`
- worst cyclic-coupling native residual: `3.377e-16`
- worst density donor/recipient native residuals: `8.909e-17` / `1.118e-16`
- worst measure donor/recipient native residuals: `1.016e-16` / `1.068e-16`
- worst restricted dW- to canonical dW+ submeasure native mass residual: `1.016e-16`
- worst permutation / translation work native residuals: `0.000e+00` / `2.169e-16`
- worst wavevector / amplitude scaling native residuals: `2.183e-16` / `2.535e-16`
- worst global-reality work-multiset native residual: `1.485e-16`
