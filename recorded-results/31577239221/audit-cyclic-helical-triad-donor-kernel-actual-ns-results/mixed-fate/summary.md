...
- mixed-fate snapshots: `5`
- snapshots with good/bad/negative work: `5` / `5` / `5`
- initial maximum good signed efficiency: `0.999996646308`
- initial unresolved mixed good dW+ mass: `8.51111181869`
- worst actual-NS signed reconstruction relative residual: `6.450e-16`
- worst `T=g+b-n` hard-cell relative residual: `1.008e-16`
- worst `T-b=g-n` reservation-certificate relative residual: `1.008e-16`
